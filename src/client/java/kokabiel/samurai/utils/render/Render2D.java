...
package kokabiel.samurai.utils.render;
...
public class Render2D
{
    ...
    public static void drawString(DrawContext drawContext, String text, float x, float y, Color color)
    {
        ...
        drawContext.drawText(samurai.fontManager.GetRenderer(), text, (int) x, (int) y, color.getColorAsInt(), false);
        matrixStack.pop();
    }
    ...
    public static void drawString(DrawContext drawContext, String text, float x, float y, int color)
    {
        ...
        matrixStack.scale(2.0f, 2.0f, 1.0f);
        matrixStack.translate(-x / 2, -y / 2, 0.0f);
        drawContext.drawText(samurai.fontManager.GetRenderer(), text, (int) x, (int) y, color, false);
        matrixStack.pop();
    }
    ...
    {
        TextRenderer textRenderer = Samurai.getInstance().fontManager.GetRenderer();
