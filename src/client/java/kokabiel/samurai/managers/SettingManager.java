...
import kokabiel.samurai.settings.types.IntegerSetting;
        ...
        for (Setting<?> setting : settings) {
            try {
                switch (setting.type) {
                    ...
                    case KEYBIND -> {
                        InputUtil.Key key = ((InputUtil.Key) setting.getValue());
                ...
                try {
                    ...
                    switch (setting.type) {
                        ...
                        case COLOR -> {
                            ...
                            ColorSetting cSetting = (ColorSetting) setting;
                            if (splits.length == 2) {
                                ColorSetting.ColorMode enumValue = Enum.valueOf(((ColorSetting) setting).getMode().getDeclaringClass(),
                                        splits[0]);
                                ...
                                if (enumValue == ColorSetting.ColorMode.Solid) {
