...
package kokabiel.samurai.gui.screens.proxy;

import kokabiel.samurai.Samurai;
import kokabiel.samurai.managers.proxymanager.Socks5Proxy;
...
public class ProxyScreen extends Screen {
	...
	protected static final RotatingCubeMapRenderer SAMURAI_ROTATING_PANORAMA_RENDERER = new RotatingCubeMapRenderer(SAMURAI_PANORAMA_RENDERER);
    ...
    public ArrayList<Socks5Proxy> getProxyList() {
        return Samurai.getInstance().proxyManager.getProxies();
    }
    ...
    public void deleteSelected() {
        ...
        Samurai.getInstance().proxyManager.removeProxy(proxy);
    ...
    public boolean isActiveProxy(Socks5Proxy proxy) {
        return Samurai.getInstance().proxyManager.getActiveProxy() == proxy;
    }
    ...
    public void setActive() {
        ...
        Samurai.getInstance().proxyManager.setActiveProxy(proxy);
    }

    public void resetActive() {
        Samurai.getInstance().proxyManager.setActiveProxy(null);
    }
