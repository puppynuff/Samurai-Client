...
import kokabiel.samurai.gui.components.CheckboxComponent;
import kokabiel.samurai.gui.components.EnumComponent;
import kokabiel.samurai.gui.components.SeparatorComponent;
import kokabiel.samurai.gui.components.SliderComponent;
...
import kokabiel.samurai.managers.pathfinding.AbstractPathManager;
import kokabiel.samurai.managers.pathfinding.FlyPathManager;
import kokabiel.samurai.managers.pathfinding.PathNode;
import kokabiel.samurai.managers.pathfinding.TeleportPathManager;
import kokabiel.samurai.managers.pathfinding.WalkingPathManager;
...
import kokabiel.samurai.utils.render.Render3D;
...
public class GoToWindow extends Window implements TickListener, Render3DListener {
	...
	private void registerEvents() {
		...
		Samurai.getInstance().eventManager.AddListener(Render3DListener.class, this);
		Samurai.getInstance().eventManager.AddListener(TickListener.class, this);
	}

	private void unregisterEvents() {
		Samurai.getInstance().eventManager.RemoveListener(Render3DListener.class, this);
