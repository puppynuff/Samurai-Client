...
public class SamuraiButtonWidget extends PressableWidget {
    private Consumer<SamuraiButtonWidget> pressAction;
    private long hoverStartTime = 0;
    private static final long HOVER_ANIMATION_DURATION = 200000000;

    public SamuraiButtonWidget(int x, int y, int width, int height, Text message) {
        super(x, y, width, height, message);
    }

    public void setPressAction(Consumer<SamuraiButtonWidget> pressAction) {
